      ...
      <div className='flex flex-col gap-8 font-medium'>
        {data.map((item, index) => (
          <div className='text-white uppercase grid grid-cols-[auto_1fr] gap-y-0 gap-x-6'>
            <p
              className={`size-12 flex items-center justify-center rounded-full border border-white group-hover:border-light-blue group-hover:bg-light-blue group-hover:text-marine-blue transition duration-300 text-xl row-span-2 ${
                step === index + 1
